    ...
    public class SeedData
    {
            ...
            IServiceProvider serviceProvider, string password)
        {
                ...
                serviceProvider.GetRequiredService<DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                //administrator
                var administratorUid = await EnsureUser(serviceProvider, "administrator@demo.com", password);
                await EnsureRole(serviceProvider, administratorUid, Constants.InvoiceAdministratorRole);
            }
        }
            ...
            IServiceProvider serviceProvider, string uid, string role)
        {
            ...
            var user = await userManger.FindByIdAsync(uid);
            if (user == null)
